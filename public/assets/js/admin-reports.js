...
function renderCategoryReport(reportData) {
    ...
    return `
        <div class="report-container">
            <div class="report-header">
                <button class="btn btn-secondary" onclick="loadPage('categories')">
                    <i class="fas fa-arrow-left"></i> Back to Categories
                </button>
                <h2><i class="${category.icon}"></i> ${category.name} - Report</h2>
            </div>
            ...
            <div class="user-info-card">
                ...
                <div class="info-grid">
                    ...
                    <div><strong>Color:</strong> <span style="display:inline-block;width:20px;height:20px;background:${category.color};border-radius:3px;"></span> ${category.color}</div>
                    <div><strong>Status:</strong> ${category.is_active ? '<span class="badge badge-success">Active</span>' : '<span class="badge badge-danger">Inactive</span>'}</div>
                </div>
            </div>
