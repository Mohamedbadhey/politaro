...
class EvidenceEditManager {
    ...
    showEditModal(evidenceId) {
        ...
        .then(data => {
            ...
            if (data.status === 'success') {
                ...
                showNotification('Failed to load evidence details', 'error');
            }
        })
        .catch(error => {
            ...
            html: `
                <div style="text-align: left;">
                    <div style="padding: 12px; background: #dbeafe; border-radius: 4px; margin-bottom: 20px;">
                        ...
                        Evidence Number: <strong>${evidence.evidence_number}</strong>
                        ${evidence.is_edited ? '<span style="background: #fbbf24; color: #000; padding: 2px 8px; border-radius: 3px; margin-left: 8px; font-size: 11px;">Previously Edited</span>' : ''}
                    </div>

                    <div style="margin-bottom: 20px; padding: 12px; background: #f3f4f6; border-radius: 4px; border-left: 4px solid #3b82f6;">
                        <div style="display: flex; align-items: center; justify-content: space-between;">
                            <div>
                                <strong style="display: block; margin-bottom: 4px;">Current File:</strong>
                    ...
                    <div style="margin-bottom: 15px;">
                        <label style="display: block; margin-bottom: 5px; font-weight: 600;">Title <span style="color: #dc2626;">*</span></label>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 15px;">
                        <div>
                            <label style="display: block; margin-bottom: 5px; font-weight: 600;">Evidence Type <span style="color: #dc2626;">*</span></label>
                            <select id="edit_evidence_type" class="swal2-select" style="width: 100%; margin: 0;">
                                <option value="photo" ${evidence.evidence_type === 'photo' ? 'selected' : ''}>Photo</option>
                                <option value="video" ${evidence.evidence_type === 'video' ? 'selected' : ''}>Video</option>
                                <option value="audio" ${evidence.evidence_type === 'audio' ? 'selected' : ''}>Audio</option>
                                <option value="document" ${evidence.evidence_type === 'document' ? 'selected' : ''}>Document</option>
                                <option value="physical" ${evidence.evidence_type === 'physical' ? 'selected' : ''}>Physical Evidence</option>
                                <option value="digital" ${evidence.evidence_type === 'digital' ? 'selected' : ''}>Digital Evidence</option>
                            </select>
                        </div>
                        <div>
                    ...
                    <div style="margin-bottom: 15px;">
                        ...
                        <input type="text" id="edit_tags" class="swal2-input" 
                               ...
                               placeholder="e.g., weapon, fingerprint, bloodstain"
                               style="width: 100%; margin: 0;">
                    </div>
                    ...
                    <div style="margin-bottom: 15px;">
                        <label style="display: flex; align-items: center; cursor: pointer;">
                            ...
                            <span style="font-weight: 600;">Mark as Critical Evidence</span>
                        </label>
                    </div>

                    <div style="padding: 12px; background: #fef3c7; border-left: 4px solid #f59e0b; border-radius: 4px;">
                        <i class="fas fa-exclamation-triangle"></i>
                        <strong>Note:</strong> All changes will be tracked and recorded in the edit history.
                    </div>
        ...
        .then(data => {
            ...
            if (data.status === 'success') {
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Update Failed',
                    text: data.message || 'Failed to update evidence'
                });
            }
        })
        .catch(error => {
        ...
        if (history.length === 0) {
            historyHtml = `
                <div style="padding: 20px; text-align: center; color: #6b7280;">
                    ...
                    <p>No edit history found for this evidence.</p>
                </div>
            `;
        } else {
                    ...
                    <table style="width: 100%; border-collapse: collapse; font-size: 13px;">
                        <thead>
                            <tr style="background: #1f2937; color: white; position: sticky; top: 0; z-index: 10;">
                                ...
                                <th style="padding: 10px; text-align: left; width: 15%;">Edited By</th>
                                <th style="padding: 10px; text-align: left; width: 15%;">Change</th>
                                <th style="padding: 10px; text-align: left; width: 27%;">Old Value</th>
                                <th style="padding: 10px; text-align: left; width: 28%;">New Value</th>
                            </tr>
                        </thead>
                        <tbody>
                                        ...
                                        <tr style="background: ${index % 2 === 0 ? '#fff3cd' : '#fffbeb'}; border-bottom: 2px solid #fbbf24;">
                                            ...
                                            <td style="padding: 10px; vertical-align: top;">
                                                <span style="background: #ef4444; color: white; padding: 4px 10px; border-radius: 4px; font-size: 12px; font-weight: 600; display: inline-block;">
                                                    <i class="fas fa-exchange-alt"></i> File Replaced
                                                </span>
                                            </td>
                                            <td style="padding: 12px; vertical-align: top; background: #f3f4f6; border-radius: 4px;">
                                                ...
                                                <button onclick="evidenceEditManager.downloadVersionById(${evidenceId}, ${entry.version_id})" 
                                                    ...
                                                    <i class="fas fa-download"></i> Download Old
                                                </button>
                                            </td>
    ...
    showReplaceFileDialog(evidenceId) {
        ...
        const dialogHtml = `
            <div style="text-align: left;">
                <div style="padding: 12px; background: #fef3c7; border-left: 4px solid #f59e0b; border-radius: 4px; margin-bottom: 15px;">
                    <i class="fas fa-exclamation-triangle"></i>
                    <strong>Warning:</strong> Replacing the file will delete the old file and track this change in history.
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 20px;">
                    ...
                    <div style="border: 2px solid #e5e7eb; border-radius: 8px; padding: 15px; background: #f9fafb;">
                        ...
                        <div style="font-size: 12px; color: #6b7280;">
                            ...
                            Size: ${(currentEvidence.file_size / 1024).toFixed(2)} KB<br>
                            Type: ${currentEvidence.file_type || 'Unknown'}
                        </div>
                    </div>
                ...
                <div style="margin-bottom: 15px;">
                    <label style="display: block; margin-bottom: 5px; font-weight: 600;">Select New File <span style="color: #dc2626;">*</span></label>
        ...
        Swal.fire({
            title: '<i class="fas fa-upload"></i> Replace Evidence File',
            html: dialogHtml,
            width: '800px',
            showCancelButton: true,
            confirmButtonText: '<i class="fas fa-upload"></i> Replace File',
            cancelButtonText: 'Cancel',
            customClass: {
                confirmButton: 'btn btn-primary',
                cancelButton: 'btn btn-secondary'
    ...
    uploadReplacementFile(evidenceId, file) {
        ...
        Swal.fire({
            ...
            html: 'Please wait while we replace the evidence file.',
            allowOutsideClick: false,
            didOpen: () => {
                Swal.showLoading();
            }
        ...
        .then(data => {
            ...
            if (data.status === 'success') {
                Swal.fire({
                    icon: 'success',
                    title: 'Success!',
                    text: 'Evidence file replaced successfully',
                    timer: 2000,
                    showConfirmButton: false
                }).then(() => {
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Upload Failed',
                    text: data.message || 'Failed to replace evidence file'
                });
            }
        })
        .catch(error => {
            ...
            Swal.fire({
                icon: 'error',
                title: 'Error',
                text: 'Error replacing file: ' + error.message
            });
        });
    }
